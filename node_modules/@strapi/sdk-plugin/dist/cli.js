          ...
          for (const ans of answers) {
            ...
            switch (name) {
              ...
              case "typescript": {
                ...
                if (isRecord(pkgJson.exports["./strapi-server"])) {
                  if (isTypescript) {
                    const { serverTypescriptFiles } = await Promise.resolve().then(() => require("./_chunks/server-Bfzl3od-.js"));
                    files.push(...serverTypescriptFiles(packageFolder));
                  } else {
                    const { serverJavascriptFiles } = await Promise.resolve().then(() => require("./_chunks/server-Bfzl3od-.js"));
