 ...
 */
const getRandomCharFromCharset = (charset) => {
 ...
 */
const expandCharacterClass = (charClass) => {
    const charsets = {
        "\\d": "0123456789",
 ...
 */
const generateFromTokens = (tokens) => {
    let result = "";
    let i = 0;
        ...
        switch (token.type) {
            ...
            case "class":
                ...
                if (tokens[i + 1] && tokens[i + 1].type === "quantifier") {
                    ...
                    else if (typeof quantifierToken.value === "string" &&
