...
// node_modules/strapi-advanced-uuid/dist/_chunks/index-DNpCuDp3.mjs
...
var PLUGIN_ID = "strapi-advanced-uuid";
...
var index = {
  ...
  async registerTrads(app) {
    ...
    const importedTranslations = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(Object.assign({ "./translations/en.json": () => import("./en-MEjm1j3q-YJJJSNTM.js") }), `./translations/${locale}.json`, 3).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=chunk-Z2TQOE3T.js.map
