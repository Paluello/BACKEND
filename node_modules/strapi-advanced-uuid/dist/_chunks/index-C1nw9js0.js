...
const index = {
  ...
  async registerTrads(app) {
    ...
    const importedTranslations = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => Promise.resolve().then(() => require("./en-CbvZRSJY.js")) }), `./translations/${locale}.json`, 3).then(({ default: data }) => {
          return {
