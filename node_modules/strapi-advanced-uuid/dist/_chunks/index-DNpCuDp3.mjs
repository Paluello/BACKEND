...
const PluginIcon = () => /* @__PURE__ */ jsx("img", { alt: "uuid", src: Icon });
...
const index = {
  ...
  async registerTrads(app) {
    ...
    const importedTranslations = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => import("./en-MEjm1j3q.mjs") }), `./translations/${locale}.json`, 3).then(({ default: data }) => {
          return {
